...
export function Home({scrollToBottom}: {scrollToBottom?: boolean}) {
    ...
    return <div className="homeStripe">
            ...
            <div className="flexNormal timelessPage">
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Internet_map_1024_-_transparent%2C_inverted.png/330px-Internet_map_1024_-_transparent%2C_inverted.png" alt="The web of the internet"/>
